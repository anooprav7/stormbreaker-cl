...
const styles = {
  ...
  lineHeight(props) {
    ...
    else if (props.variant && props.fontSize !== 0)
      return props.theme.typographyVariants[props.variant].lineHeight
    else return ""
  },
  ...
  fontSize(props) {
    if (props.fontSize || props.fontSize === 0) {
      ...
      return props.theme.typographyVariants[props.variant].size
    else return ""
  }
}
...
const StyledText = styled(
  ...
  margin-bottom: ${props =>
    props.mb ? props.theme.sizeOfSpace(props.mb) : ""};
  ...
  margin-bottom: ${props =>
    props.my ? props.theme.sizeOfSpace(props.my) : ""};
