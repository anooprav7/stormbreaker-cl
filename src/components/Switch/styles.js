...
export default {
  ...
  size :{
    height(props) {
      const {size} = props
      if(size=="small")
        return theme.sizeOfSpace(5)
      else if(size === "medium")
        return theme.sizeOfSpace(6)
      else if(size==='large')
        return theme.sizeOfSpace(7)
      else 
        return theme.sizeOfSpace(5)
    },
    width(props) {
      const {size} = props
      if(size=="small")
        return theme.sizeOfSpace(10)
      else if(size === "medium")
        return theme.sizeOfSpace(12)
      else if(size==='large')
        return theme.sizeOfSpace(14)
      else 
        return theme.sizeOfSpace(10)
    }
  }
